...
<body>
    ...
    <div class="row container">
        ...
        <article class="col s12 l4 center hoverable">
            <img src="./_img/hotel-sao-paulo.jpg" class="circle responsive-img" alt="">
        ...
        <article class="col s12 l4 center hoverable">
            <img src="./_img/hotel-rio.jpg" class="circle responsive-img" alt="">
            <h5>Hotel Rio de Janeiro</h5>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
            <a href="" class="btn teal">Ler mais</a><br><br>
        </article>
        ...
        <!-- HOTEL CEARA -->
        <article class="col s12 l4 center hoverable">
            <img src="./_img/hotel-ceara.jpg" class="circle responsive-img" alt="">
            <h5>Hotel Ceará</h5>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
            <a href="" class="btn teal">Ler mais</a><br><br>
        </article>
